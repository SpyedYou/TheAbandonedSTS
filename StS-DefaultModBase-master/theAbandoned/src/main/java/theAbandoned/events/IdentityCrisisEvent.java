...
import static theAbandoned.TheAbandonedMod.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = TheAbandonedMod.makeID("IdentityCrisisEvent");
    ...
    private float HEALTH_LOSS_PERCENTAGE = 0.08F; // 8%
    ...
    public IdentityCrisisEvent() {
        ...
        if (AbstractDungeon.ascensionLevel >= 15) { // If the player is ascension 15 or above, lose 8% max hp. Else, lose just 5%.
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("theAbandonedResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
