...
public class AxeThrow extends CustomCard {
    ...
    public static final String ID = TheAbandonedMod.makeID(AxeThrow.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("AxeThrow.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        //AbstractDungeon.actionManager.addToBottom(new DiscardToTopOfDeck(this));
    }
