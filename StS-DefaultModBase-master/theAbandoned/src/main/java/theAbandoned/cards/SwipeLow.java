...
public class SwipeLow extends CustomCard {

    /*
     * Deal 8(10) Damage.
     * Apply 1(2) Vulnerable
     * Alternate - Apply 1(2) Weak.
     */

    public static final String ID = TheAbandonedMod.makeID(SwipeLow.class.getSimpleName());
    ...
    public static final AbstractCard ALTERNATE_CARD = new SwipeHigh();
