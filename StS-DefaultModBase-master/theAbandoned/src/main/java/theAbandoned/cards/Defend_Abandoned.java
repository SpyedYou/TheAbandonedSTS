...
public class Defend_Abandoned extends AbstractDynamicCard {
    ...
    public static final String ID = TheAbandonedMod.makeID(Defend_Abandoned.class.getSimpleName());
